...
const Sidebar = ({ onNavigate, currentPage }: any) => {
  ...
  return (
    <div className="flex flex-col shrink-0 h-full md:border-r md:border-gray-800 bg-black w-20 lg:w-64 transition-all duration-200">
      ...
      <nav className="flex-1 px-1 lg:px-2 space-y-1">
        ...
        <div className="pt-2 px-1 lg:px-0">
          <Button
            onClick={() => onNavigate("home")}
            className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full py-3 lg:py-6 flex items-center justify-center transition-colors"
          >
        ...
        <div className="p-2 lg:p-4 border-t border-gray-800">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="w-full flex items-center justify-center lg:justify-start gap-3 p-2 lg:p-3 rounded-full hover:bg-gray-800"
              >
